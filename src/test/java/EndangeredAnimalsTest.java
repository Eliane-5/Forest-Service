...
public class EndangeredAnimalsTest {
    ...
    public void endangeredAnimal_instantiatesCorrectly_true() {
        EndangeredAnimals testAnimal = new EndangeredAnimals(1,"cats","good",2);
    ...
    public void endangeredAnimal_instantiatesWithAnimalId_int() {
        EndangeredAnimals testAnimal = new EndangeredAnimals(1,"cats","good",2);
        assertEquals(1, testAnimal.getAnimalId());
    }
    @Test
    ...
    public void equals_returnsTrueIfAnimalIsSameWithOther_True() {
        EndangeredAnimals testAnimal = new EndangeredAnimals(1,"cats","good",2);
        EndangeredAnimals anotherAnimal = new EndangeredAnimals(1,"cats","good",2);
    ...
    public void all_returnsAllInstancesOfEndangeredAnimal_true() {
        EndangeredAnimals testAnimal = new EndangeredAnimals(1,"cats","good",2);
        testAnimal.save();
        EndangeredAnimals secondAnimal = new EndangeredAnimals(1,"dogs","good",2);
        secondAnimal.save();
    ...
    public void find_returnsAnimalsWithSameId_secondAnimal() {
        EndangeredAnimals testAnimal = new EndangeredAnimals(1,"cats","good",2);
        testAnimal.save();
        EndangeredAnimals secondAnimal = new EndangeredAnimals(2,"dogs","good",2);
        secondAnimal.save();
